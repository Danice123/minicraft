...
public class CompressedStreamTools
{
     ...
     */
    public static NBTCompound readCompressed(InputStream par0InputStream) throws IOException
    {
        DataInputStream datainputstream = new DataInputStream(new BufferedInputStream(new GZIPInputStream(par0InputStream)));

        try
        {
            NBTCompound nbttagcompound = read(datainputstream);
     ...
     */
    public static void writeCompressed(NBTCompound par0NBTTagCompound, OutputStream par1OutputStream) throws IOException
    {
    ...
    public static NBTCompound decompress(byte par0ArrayOfByte[]) throws IOException
    {
    ...
    public static byte[] compress(NBTCompound par0NBTTagCompound) throws IOException
    {
    ...
    public static void safeWrite(NBTCompound par0NBTTagCompound, File par1File) throws IOException
    {
    ...
    public static NBTCompound read(File par0File) throws IOException
    {
        if (!par0File.exists())
        {
            return null;
     ...
     */
    public static NBTCompound read(DataInput par0DataInput) throws IOException
    {
    ...
    public static void write(NBTCompound par0NBTTagCompound, DataOutput par1DataOutput) throws IOException
    {
