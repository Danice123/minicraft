...
public class NBTList extends NBTBase
{
    ...
    public NBTBase copy()
    {
        NBTList nbttaglist = new NBTList(getName());
        nbttaglist.tagType = tagType;
        NBTBase nbtbase1;

        for (Iterator<NBTBase> iterator = tagList.iterator(); iterator.hasNext(); nbttaglist.tagList.add(nbtbase1))
        {
    ...
    public boolean equals(Object par1Obj)
    {
        ...
        {
            NBTList nbttaglist = (NBTList)par1Obj;
    ...
    public void removeTag(NBTBase nbtbase) {
    	tagList.remove(nbtbase);
    }
